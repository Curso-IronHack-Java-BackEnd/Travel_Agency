...
public class Agent extends Person {
    ...
    public Agent(String firstName, String lastName, String phoneNumber, String email, String specialization, BigDecimal commissionRate, List<Reservation> reservations, Manager manager) {
